      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(docName, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: c.textPrimary)),
          ]),
        ]),
        ...
        SizedBox(width: double.infinity,
          child: TextButton(
            ...
            child: Text(AppStrings.cancel, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: c.textSecondary)),
          ),
        ),
      ]),
    );
            ...
            Row(children: [
              Expanded(
                child: TextButton(
                  ...
                  child: Text('رجوع', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: c.textSecondary)),
                ),
              ),
              ...
              Expanded(
                child: TextButton(
                  ...
                  child: Text('إلغاء الموعد', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: c.error)),
                ),
              ),
            ]),
          ]),
