...
class ReceptionistPatientsView extends StatefulWidget {
  const ReceptionistPatientsView({super.key});

  @override
  State<ReceptionistPatientsView> createState() => _ReceptionistPatientsViewState();
}
