...
class AppProviders {
  ...
  static List<BlocProvider> blocProviders(BuildContext context) {
    return [
      BlocProvider(create: (ctx) => AuthCubit(authRepository: RepositoryProvider.of<AuthRepository>(ctx))),
      BlocProvider(create: (_) => OnboardingCubit()),
      BlocProvider(create: (ctx) => DoctorBloc(RepositoryProvider.of<DoctorRepository>(ctx))),
      BlocProvider(create: (ctx) => PatientBloc(RepositoryProvider.of<PatientRepository>(ctx))),
      BlocProvider(create: (ctx) => AppointmentBloc(RepositoryProvider.of<AppointmentRepository>(ctx))),
      BlocProvider(create: (ctx) => MedicalRecordBloc(RepositoryProvider.of<MedicalRecordRepository>(ctx))),
      BlocProvider(create: (ctx) => DoctorProfileBloc(RepositoryProvider.of<DoctorRepository>(ctx))),
      BlocProvider(create: (ctx) => ProfileCubit(authRepository: RepositoryProvider.of<AuthRepository>(ctx))),
      BlocProvider(create: (ctx) => LocationCubit(locationRepository: RepositoryProvider.of<LocationRepository>(ctx))..loadCountries()),
      BlocProvider(create: (ctx) => DashboardBloc(RepositoryProvider.of<DashboardRepository>(ctx))),
      BlocProvider(create: (ctx) => RatingBloc(repository: RepositoryProvider.of<RatingRepository>(ctx))),
      BlocProvider(create: (_) => DownloadFileBloc()),
      BlocProvider(create: (ctx) => NotificationBloc(RepositoryProvider.of<NotificationRepository>(ctx))),
      BlocProvider(create: (ctx) => PrescriptionBloc(RepositoryProvider.of<PrescriptionRepository>(ctx))),
      BlocProvider(create: (ctx) => RbacBloc(RepositoryProvider.of<RbacRepository>(ctx))),
      BlocProvider(create: (ctx) => SupervisionBloc(RepositoryProvider.of<SupervisionRepository>(ctx))),
      BlocProvider(create: (ctx) => ReceptionistBloc(RepositoryProvider.of<ReceptionistRepository>(ctx))),
      BlocProvider(create: (ctx) => UserBloc(RepositoryProvider.of<UserRepository>(ctx))),
    ];
  }
}
