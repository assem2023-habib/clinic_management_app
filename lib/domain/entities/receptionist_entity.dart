...
class ReceptionistEntity extends UserEntity {
  ...
  factory ReceptionistEntity.fromUser(UserEntity user, {String? shiftStart, String? shiftEnd}) {
    return ReceptionistEntity(
      ...
      gender: user.gender, birthdayDate: user.birthdayDate,
      roles: user.roles, isActive: user.isActive,
      imageUrl: user.imageUrl, countryId: user.countryId,
      cityId: user.cityId, fcmTokens: user.fcmTokens,
  ...
  ReceptionistEntity copyWith({
    ...
    String? birthdayDate, List<RoleEntity>? roles, bool? isActive,
    String? imageUrl, String? countryId, String? cityId,
    List<String>? fcmTokens, String? emailVerifiedAt,
    String? createdAt, String? updatedAt,
    String? shiftStart, String? shiftEnd,
  }) {
    return ReceptionistEntity(
      id: id ?? this.id, firstName: firstName ?? this.firstName,
      lastName: lastName ?? this.lastName, username: username ?? this.username,
      email: email ?? this.email, phone: phone ?? this.phone,
      address: address ?? this.address, gender: gender ?? this.gender,
      birthdayDate: birthdayDate ?? this.birthdayDate,
      roles: roles ?? this.roles, isActive: isActive ?? this.isActive,
